...
<html lang="pt-br">
    <head>
        <meta charset="UTF-8">
        <meta name="mit" content="2017-09-18T12:02:17-03:00+18267">
    ...
    <body class="login">
        <div class="container login_container">
            <div class="login_box">
                <img class="login_logo" alt="<?= ADMIN_NAME; ?>" title="<?= ADMIN_NAME; ?>" src="_img/logo.png"/>
                ...
                <p class="login_link"><a href="recover.php">Perdeu sua senha?</a></p>
            </div>
        </div>
