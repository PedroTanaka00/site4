...
<div class="dashboard_content">
    ...
    if (!$Read->getResult()):
        ...
        foreach ($Read->getResult() as $PAGE):
            ...
            $page_cover = (!empty($page_cover) && file_exists("./uploads/".$page_cover) && !is_dir("./uploads/".$page_cover) ? "{$page_cover}" : 'admin/_img/no_image.jpg');
			
            echo "<article class='box box25 page_single wc_draganddrop' callback='Pages' callback_action='pages_order' id='{$page_id}'>
                <a title='Ver página no site' target='_blank' href='" . BASE . "/tim.php?src={$page_cover}&w=400&h=200'><img alt='' title='' src='" . BASE . "/tim.php?src={$page_cover}&w=400&h=200'/></a>
