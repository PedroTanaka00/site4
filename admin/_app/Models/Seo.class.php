    ...
    private function setPach() {
        ...
        if (in_array($this->File, $Pages)):
            ...
            if ($Read->getResult()):
                ...
                $this->Image = (!empty($Page['page_cover']) ? BASE . "/uploads/{$Page['page_cover']}" : INCLUDE_PATH . '/images/logo.png');
            else:
                $this->set404();
            endif;
        elseif ($this->File == 'index'):
            ...
            $this->Image = INCLUDE_PATH . '/images/logo.png';
        ...
        elseif ($this->File == 'favoritos'):
            //FAVORITOS
            $this->Schema = 'WebSite';
            $this->Title = SITE_NAME . " - Meus Favoritos";
            $this->Description = SITE_DESC;
            $this->Image = INCLUDE_PATH . '/images/logo.png';
